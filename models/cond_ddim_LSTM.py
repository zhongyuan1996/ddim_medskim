...
class condDiffRNN(nn.Module):
    ...
    def forward(self, input_seqs, seq_time_step):
        ...
        visit_embedding_gen = torch.zeros_like(visit_embedding)
        ...
        for i in range(visit_size):
            ...
            visit_embedding_gen[:, i:i+1, :] = seq_visit_embedding_generated2.permute(1, 0, 2)
        ...
        return visit_embedding, visit_embedding_gen, \
