...
def train(args):
    ...
    if str(args.model) + '_LD'+str(args.lambda_DF_loss)+'_LS'+str(args.lambda_CE_gen_loss) + '_' + str(args.target_disease) + '_' + str(args.seed) + '.csv' in files:
        ...
        results_file = open(str(args.model) + '_LD'+str(args.lambda_DF_loss)+'_LS'+str(args.lambda_CE_gen_loss) + '_' + str(args.target_disease) + '_' + str(args.seed) + '.csv', 'w', encoding='gbk')
