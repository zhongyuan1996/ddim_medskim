...
class MIMIC4_icd9_TrainingConfig:
    ...
    # Data paths
    mimiciv_mapping_path: str = '/data/yuanzhong/physionet.org/files/mimic_iv_icd9_code_to_index.pkl'
    mimiciv_train_path: str = '/data/yuanzhong/physionet.org/files/mimic_iv_icd9_train_ehr.pkl'
    mimiciv_val_path: str = '/data/yuanzhong/physionet.org/files/mimic_iv_icd9_val_ehr.pkl'
    mimiciv_test_path: str = '/data/yuanzhong/physionet.org/files/mimic_iv_icd9_test_ehr.pkl'
    mimiciv_toy_path: str = '/data/yuanzhong/physionet.org/files/mimic_iv_icd9_toy_ehr.pkl'
