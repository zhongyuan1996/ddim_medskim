...
def train(args):
    ...
    if csv_filename in files:
        ...
        if args.model == 'MedDiffGa':
                model = MedDiffGaB(pad_id_list, args.d_model, args.dropout, args.dropout_emb, args.num_layers, demo_len, device,channel_list=[args.d_model,int(args.d_model*2),int(args.d_model*4)])
        else:
...
if __name__ == '__main__':
    ...
    save_path = './saved_EHRPD_learnDiff_'
    names = ['MedDiffGa']
