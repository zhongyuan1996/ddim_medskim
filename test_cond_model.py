...
from models.conditioned_diff_LSTM import *
import yaml
...
def main():
    ...
    parser.add_argument("--num_contrast", type=int, default=5, help="number of contrastive samples")
...
def train(args):
    ...
    model = cond_diffRNN(config, vocab_size=pad_id, d_model=args.d_model, h_model=args.h_model,
                    dropout=args.dropout, dropout_emb=args.dropout_emb, device = device, num_contrast = args.num_contrast)
